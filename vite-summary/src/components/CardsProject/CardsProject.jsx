        ...
        <div className='rotating-card'>
          ...
          <div className='top-line'>
            <div className='rectangle' ref={cardRefs[0]}>
              {randomCard1 && <CardComponent randomCard={randomCard1} />}
            </div>
          </div>
          <div className='bottom-line'>
            <div className='rectangle' ref={cardRefs[1]}>
              {randomCard2 && <CardComponent randomCard={randomCard2} />}
            </div>
          </div>
          <div className='left-line'>
            <div className='rectangle' ref={cardRefs[2]}>
              {randomCard3 && <CardComponent randomCard={randomCard3} />}
            </div>
            <div className='rectangle' ref={cardRefs[3]}>
              {randomCard4 && <CardComponent randomCard={randomCard4} />}
            </div>
          </div>
          <div className='right-line'>
            <div className='rectangle' ref={cardRefs[4]}>
              {randomCard5 && <CardComponent randomCard={randomCard5} />}
            </div>
            <div className='rectangle' ref={cardRefs[5]}>
              {randomCard6 && <CardComponent randomCard={randomCard6} />}
            </div>
          </div>
        </div>
      </div>
